...
class TestLGIS(unittest.TestCase):
    ...
    def test_longest_decreasing_subsequence_of_sample_is_542_or_543(self):
        self.assertTrue(self.lgis.get_longest_decreasing_subsequence(self.sample_permutation) == [5,4,2] or self.lgis.get_longest_decreasing_subsequence(self.sample_permutation) == [5,4,3])